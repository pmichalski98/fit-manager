...
export function TrainingCardioSessionView({ session, template }: Props) {
  ...
  const form = useForm<any>({
    resolver: zodResolver(cardioSessionSchema) as unknown as Resolver<any>,
    defaultValues: { durationSec: 0, distanceM: undefined, kcal: undefined, avgHr: undefined, avgSpeedKmh: undefined, avgPowerW: undefined, notes: "" },
  });
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            />
            <FormField control={form.control} name="kcal" render={({ field }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="distanceM" render={({ field }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="avgHr" render={({ field }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="avgSpeedKmh" render={({ field }) => (
              <FormItem>
                <FormLabel>Avg Speed (km/h)</FormLabel>
                <FormControl>
                  <Input type="number" step="0.1" inputMode="decimal" value={field.value ?? ""} onChange={(e) => field.onChange(e.target.value === "" ? undefined : Number(e.target.value))} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )} />
            <FormField control={form.control} name="avgPowerW" render={({ field }) => (
              <FormItem>
