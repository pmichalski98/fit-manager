...
export default function UserButton() {
  ...
  return (
    <>
      <DropdownMenu>
        <DropdownMenuTrigger className="dark:bg-input/30 dark:hover:bg-input/50 hover:bg-muted flex items-center justify-between gap-1 overflow-hidden rounded-lg border p-3 px-4 py-1.5 transition-colors">
          <Avatar>
            {" "}
            {user.image ? (
